...
python train.py --epochs 200 --batch-size 1 --classes 6 --data-path 'data/tongji_parking_rgbi_slice_splitted_truergbi' --model SwinTransformer_pretrained  --scale 0.5 --use-intensity 0 --learning-rate 0.000001 --use-diceloss 0